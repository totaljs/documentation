...
Tangular.register("lower", function(e) {
    ...
    for (var a = 0, t = e.length; t > a; a++) {
        ...
        o.options && (m = o.options.map(function(e) {
            return "<span>" + e + "</span>"
        })), n.push("<td>" + (m ? m.join("") : "") + (o.description || "") + (o["default"] !== undefined ? '<div class="member-body-default"><b>Default value</b>: ' + o["default"] + "</div>" : "") + (o.params ? "<div><b>function " + o.name + "(" + r + ") {}</b>" + Thelpers.params(o.params) + "</div>" : "") + "</td>"), n.push("</tr>")
    }
